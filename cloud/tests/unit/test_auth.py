...
def test_extract_tenant_from_auth_missing_header():
    """Test missing authorization header -> ValueError"""
...
def test_extract_tenant_from_auth_malformed_base64():
    """Test malformed base64 -> ValueError"""
...
def test_extract_tenant_from_auth_malformed_json():
    """Test valid base64 but malformed JSON payload -> ValueError"""
    # base64 representing "{bad-json"
